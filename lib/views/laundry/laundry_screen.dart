...
import 'package:mksc/views/laundry/widgets/laundry_data_card.dart';
...
class _LaundryScreenState extends State<LaundryScreen> {
                  ...
                  child: SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        final isDisabled = laundryDataList.any((data) =>
                            data.machineType == laundryMachine.machineType);
                          ...
                          children: [
                            ...
                            Form(
                              ...
                              child: AppTextFormField(
                                ...
                                validator: (value) =>
                                    ValidatorUtility.validateRequiredField(
                                        value,
                                        "Integer Quantity for ${selectedLaundryMachine!.machineType} circle is required"),
                              ),
                            ),
                            const SizedBox(
                              height: 21,
                                    ...
                                    : Button(
                                        ...
                                        onTap: () async {
                                          if (_formKey.currentState!
                                            ...
                                            await Provider.of<
                                                        LaundryMachineProvider>(
                                                    context,
                                                    listen: false)
                                                .saveLaundryDataByDate(
                                                    context,
                                                    camp: widget.camp,
                                                    circle:
                                                        dataController.text,
  ...
  void fetchLaundryMachines() async {
    ...
    await Provider.of<LaundryMachineProvider>(context, listen: false)
        .fetchLaundryMachines(camp: widget.camp);
    setState(() {
  ...
  void fetchLaundryDataByDate(
    ...
    await Provider.of<LaundryMachineProvider>(context, listen: false)
        .getLaundryDataByDate(camp: widget.camp, date: date);
    setState(() {
