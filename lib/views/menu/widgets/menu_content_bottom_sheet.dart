...
import 'package:mksc/views/menu/menu_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        AppAnimatedSwitcher(
          show: selectedMenuTypePerCamp.isNotEmpty,
          child: Padding(
            padding: const EdgeInsets.only(left: 8.0, right: 8.0),
            child: Card(
              elevation: 0,
        ...
        AppAnimatedSwitcher(
          show: selectedCamp.isNotEmpty || selectedDay.isNotEmpty || selectedMenu.isNotEmpty || selectedMenuTypePerCamp.isNotEmpty,
          child: Padding(
        ...
        AppAnimatedSwitcher(
          show: selectedCamp.isNotEmpty && selectedDay.isNotEmpty && realSelectedMenu.camp.isNotEmpty && selectedMenuTypePerCamp.isNotEmpty,
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Button(
              title: "Check Menu", 
