...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    DetailedMenu detailedMenu =
        Provider.of<MenuProvider>(context, listen: true).detailedMenu;
    ...
    return Scaffold(
      body: DefaultTabController(
          ...
          child: Scaffold(
                    ...
                    return GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: Icon(
                          ...
                          color: Colors.white,
                          size:
                              Provider.of<ThemeProvider>(context).fontSize + 7,
                        ),
                      ),
                    );
                  },
                ...
                bottom: TabBar(
                  ...
                  tabs: [
                    Padding(
                      ...
                      child: Text('Portion Configurations',
                          style: Theme.of(context)
                              .textTheme
                              .bodyMedium
                              ?.copyWith(color: Colors.white)),
            ...
            floatingActionButton: detailedMenu.video.isEmpty
                ? null
                : FloatingActionButton(
                    onPressed: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                VideoScreen(detailedMenu: detailedMenu),
                          ));
                    },
                    tooltip: "Video",
                    shape: const OvalBorder(
                        eccentricity: 1, side: BorderSide.none),
                    backgroundColor: Theme.of(context).colorScheme.primary,
                    child: const Icon(
